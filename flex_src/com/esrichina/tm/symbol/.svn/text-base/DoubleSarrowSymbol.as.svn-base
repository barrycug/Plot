package com.esrichina.tm.symbol
{
	...
	import com.esrichina.tm.geometry.DoubleSarrow;
	...
	public class DoubleSarrowSymbol extends CustomFillSymbol
	{
		public function DoubleSarrowSymbol(type:String=null)
		{
			super(type);
			this.type=type;
			this.color=0xB22222;
		...
		{
			if (geometry is DoubleSarrow)
			{
				drawSarrow(sprite, map, geometry as DoubleSarrow);
			}
		}

		private function drawSarrow(sprite:Sprite, map:Map, sarrow:DoubleSarrow):void
		{
