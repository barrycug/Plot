package com.esrichina.tm.symbol
{
	...
	import com.esrichina.tm.geometry.TailSarrow;
	...
	public class TailSarrowSymbol extends CustomFillSymbol
	{
		public function TailSarrowSymbol(type:String=null)
		{
			super(type);
			this.type=type;
			this.color=0xB22222;
		...
		{
			if (geometry is TailSarrow)
			{
				drawSarrow(sprite, map, geometry as TailSarrow);
			}
		}

		private function drawSarrow(sprite:Sprite, map:Map, sarrow:TailSarrow):void
		{
