...
{
	if (graphicconsumer.channelSet == null || graphicproduce.channelSet == null)
	{
		var channelSet:ChannelSet=new ChannelSet(["my-streaming-amf", "my-polling-amf"], false);
		graphicconsumer.channelSet=channelSet;
		graphicproduce.channelSet=channelSet;
	}
	if (!graphicconsumer.subscribed)
